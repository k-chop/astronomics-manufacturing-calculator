...
export function MaterialsSummary({ materials, locale = "en" }: MaterialsSummaryProps) {
  ...
  return (
    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg shadow-md p-6 border-2 border-blue-200">
      <h2 className="text-xl font-bold mb-4 text-gray-900">Total Materials Needed</h2>
      <p className="text-sm text-gray-600 mb-4">Aggregated materials for all incomplete items in your plan</p>
