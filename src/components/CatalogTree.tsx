  ...
  if (node.kind === "leaf") {
    ...
    return (
      <button
        ...
        style={indentStyle}
        className={`w-full text-left text-base rounded px-2 py-1 flex items-center ${
  ...
  return (
    <div>
      <button
        ...
        style={indentStyle}
        className="w-full text-left text-base font-medium text-gray-700 rounded px-2 py-1 hover:bg-gray-100 flex items-center gap-1"
      >
  ...
  return (
    <div className="bg-white rounded-lg shadow-md">
      ...
      <div className="sticky top-0 z-10 bg-white rounded-t-lg px-4 pt-4 pb-3">
        <div className="relative">
          <input
            ...
            className="w-full px-3 py-2 pr-8 text-base border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
          {isFiltering && (
            <button
              type="button"
              ...
              onClick={() => setQuery("")}
              className="absolute right-2 top-1/2 -translate-y-1/2 w-5 h-5 flex items-center justify-center rounded-full bg-gray-200 text-gray-500 text-sm leading-none hover:bg-gray-300 hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
              ✕
            </button>
          )}
      ...
      {visibleTree.length === 0 ? (
        <p className="text-base text-gray-500 px-6 pb-4">No items or upgrades match.</p>
      ) : (
